				...
				<xsl:for-each select="/icestats">
					<xsl:for-each select="*">
						<xsl:if test = "name()!='source'"> 
							<tr>
							   <td>bitch<xsl:value-of select="name()" /></td>
				...
				<div class="mounthead">
					...
					<div class="right">
						<xsl:choose>
							...
							<xsl:otherwise>
								<ul class="mountlist">
									<li><a class="play" href="{@mount}.m3u">Download this m3u file to stream in VLC or foobar2000</a></li>
									<li><a class="play" href="{@mount}.xspf">I have no idea what this XSPF file is</a></li>
